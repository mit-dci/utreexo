...
func (msg *MsgBlock) DeserializeTxLoc(r *bytes.Buffer) ([]TxLoc, error) {
	...
	txCount, err := util.ReadVarInt(r, 0)
	if err != nil {
		return nil, err
	}
...
func (msg *MsgBlock) BtcEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	err = util.WriteVarInt(w, pver, uint64(len(msg.Transactions)))
	if err != nil {
		return err
	}
...
func (msg *MsgBlock) SerializeSize() int {
	...
	// transactions.
	n := blockHeaderLen + util.VarIntSerializeSize(uint64(len(msg.Transactions)))
