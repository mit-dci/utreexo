...
func (f *Forest) Undo(ub undoBlock) error {
	...
	// TODO: do we need this gap thing at all?
	// if you just put the hashes in the right order (hmm) to the right of the
	// last leaf, then it should swap around into the right place
